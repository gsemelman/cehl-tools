...
public class PlayerStatHolder {
	...
	public void setPpToi(int ppToi) {
		this.ppToi = ppToi;
	}
	...
	public int getPpAssists() {
		return ppAssists;
	}
	public void setPpAssists(int ppAssists) {
		this.ppAssists = ppAssists;
	}
	...
	public void setPkToi(int pkToi) {
		this.pkToi = pkToi;
	}
	public int getPim() {
		return pim;

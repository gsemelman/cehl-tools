...
public class RosterRaw implements Serializable{
    ...
    private int teamId;
	private int teamPlayerId; //relative based on location in file. 0-49, resets by team
	private String name; //0-21
	private int position; // 22
	private int jersey; //23
	private int vetRookieStatus1; //24
	private int vetRookieStatus2; //25
	private int hand; //26
	...
	public String toString() {
		return String
				.format("RosterRaw [teamId=%s, teamPlayerId=%s, name=%s, position=%s, jersey=%s, vetRookieStatus1=%s, vetRookieStatus2=%s, hand=%s, height=%s, weight=%s, age=%s, injStatus=%s, condition=%s, it=%s, sp=%s, st=%s, en=%s, du=%s, di=%s, sk=%s, pa=%s, pc=%s, df=%s, sc=%s, ex=%s, ld=%s, filler1=%s, salary=%s, contractLength=%s, suspStatus=%s, gamesPlayed=%s, goals=%s, assists=%s, plusMinus=%s, plusMinus2=%s, pims=%s, pims2=%s, shots=%s, shots2=%s, ppGoals=%s, shGoals=%s, gwGoals=%s, gtGoals=%s, goalStreak=%s, pointStreak=%s, filler3=%s, filler4=%s, filler5=%s, filler6=%s, farmGoals=%s, farmAssists=%s, filler7=%s, filler8=%s, filler9=%s, birthPlace=%s, filler10=%s, filler11=%s, farmGamesPlayed=%s, farmPim=%s, farmPim2=%s, hits=%s, hits2=%s]",
						teamId, teamPlayerId, name, position, jersey,
...
//        return this.name.compareTo(roster.name);
//	}
